...
import org.tyler.husher.client.ui.component.ChannelBox;
import org.tyler.husher.client.ui.component.ChannelPane;
import org.tyler.husher.client.ui.component.NetworkIndicatorBox;
import org.tyler.husher.core.network.model.Channel;
...
public class HomePanel extends GridPane {
    ...
    public HomePanel() {
        MainFrame.INSTANCE.setSize(800, 440);
        ...
        searchTextField.setOnMouseClicked(event -> showSearchMenu());
        ...
        Label usernameLabel = new Label(Husher.getUserData().getUsername());
    ...
    private void showSearchMenu() {
        ...
        searchField.setStyle("-fx-font-size: 12px; -fx-text-fill: white; -fx-background-color: #3d3d3d;");
        ...
        // layout.getBody().addAll(searchField);
        //
        // JFXAlert<Void> alert = new JFXAlert<>(getScene().getWindow());
    ...
    private ChannelBox createChannelBox(Channel channel, String color) {
        ...
        int size = 32;
        ImageView iconView = new ImageView(new Image(ResourceUtils.openResource("images/icon.png")));
    ...
    private GridPane createCenterPane() {
        ...
        inputTextField.setStyle("-fx-font-size: 12px; -fx-display-caret: true; -fx-highlight-fill: #7a7a7a; -fx-text-fill: #ecf0f1; -fx-background-color: #3d3d3d; -fx-prompt-text-fill: #aaa69d;");
    ...
    private void fireInputTextFieldActionEvent() {
        ...
        if (focusedChannelPane != null) {
            User authorUser = new User(0, "aaaa", null);
