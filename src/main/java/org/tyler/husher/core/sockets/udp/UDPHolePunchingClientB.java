package org.tyler.husher.core.sockets.udp;

import java.net.DatagramPacket;
import java.net.DatagramSocket;
import java.net.InetAddress;

public class UDPHolePunchingClientB {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DatagramPacket sendPacket = new DatagramPacket(sendData, sendData.length, InetAddress.getByName("127.0.0.1"), 7071);
        ...
        try {
            while(true)
            {
                ...
                DatagramPacket sPacket = new DatagramPacket(sendData, sendData.length, receivePacket.getAddress(), receivePacket.getPort());
